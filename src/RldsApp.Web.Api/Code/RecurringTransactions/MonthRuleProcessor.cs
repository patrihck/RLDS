...
{
	internal class MonthRuleProcessor : RuleProcessorBase
	{
		private readonly RecurringTransactionMonthRule _rule;

		public MonthRuleProcessor(RecurringTransactionMonthRule rule)
		{
