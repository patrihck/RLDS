...
{
	internal class WeekRuleProcessor : RuleProcessorBase
	{
		private readonly RecurringTransactionWeekRule _rule;

		public WeekRuleProcessor(RecurringTransactionWeekRule rule)
		{
